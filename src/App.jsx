...
function App() {
  ...
  return (
    <div className={`min-h-screen w-screen font-League flex-col justify-center items-center p-6 ${rangeValue === 2 ? 'bg-theme2-background-main text-theme3-text-darkBlue ' : rangeValue === 3 ? 'bg-theme3-background-main text-theme3-text-yellow ' : 'bg-theme1-background-main text-white'}`}>
      <div className='flex flex-1 justify-between items-center w-full md:max-w-[550px] mx-auto'>
        <div>
          ...
          <div>
            <form className='flex gap-7 items-center justify-end'>
              ...
              <div className='flex items-center rounded-xl'>
                <input onChange={selector} className={`border-none appearance-none rounded-xl w-[70px] h-[25px] px-1 ${rangeValue === 2 ? 'accent-theme2-key-toggleBg bg-theme2-background-toggle' : rangeValue === 3 ? 'accent-theme3-key-toggleBg bg-theme3-background-toggle' : 'accent-theme2-key-toggleBg bg-theme1-background-toggle'}`} type="range" min={1} max={3} />
              </div>
            </form>
          </div>
        </div>
      ...
      <div className={`w-[330px] h-[90px] rounded-xl mt-8 mx-auto md:w-[550px] ${rangeValue === 2 ? 'bg-theme2-background-screen' : rangeValue === 3 ? 'bg-theme3-background-screen' : 'bg-theme1-background-screen'}`}>
      ...
      <div className={` flex flex-col p-6 md:p-8 my-6 rounded-xl w-[330px] h-full md:w-[550px] mx-auto ${rangeValue === 2 ? 'bg-theme2-background-toggle' : rangeValue === 3 ? 'bg-theme3-background-toggle' : 'bg-theme1-background-toggle'}`}>
        <div className="flex gap-[13px] md:gap-[22px] mb-[13px] md:mb-[22px]">
        ...
        <div className="flex gap-[13px] mb-[13px] md:gap-[22px] md:mb-[22px]">
        ...
        <div className="flex gap-[13px] md:gap-[22px]">
